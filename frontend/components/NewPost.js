    ...
    return (
        <form onSubmit={newMsg} className="fixed right-3 lg:w-[32%]  box-border my-3 bg-white p-4 rounded-lg shadow dark:bg-gray-900 ">
            ...
            <div className="flex py-2">
                ...
                <input type="search" value={imgurl} onChange={(e) => setImgurl(e.target.value)} id="default-search" className="block w-full px-4 py-2 mr-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter url...." required />
