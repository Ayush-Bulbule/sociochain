...
export default function Sidebar({ isOpen }) {
  ...
  return (
    <>
      ...
      <aside id="default-sidebar" className={`sidebar ${isSidebarOpen ? '' : '-translate-x-full'} fixed border-r-2 border-gray-200 top-0 left-0 z-40 w-64 h-screen transition-transform  sm:translate-x-0 dark:bg-gray-900 dark:border-slate-700`} aria-label="Sidebar">
