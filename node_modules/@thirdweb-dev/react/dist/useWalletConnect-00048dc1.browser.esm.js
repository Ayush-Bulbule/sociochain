import React, { useState, useEffect, useCallback, useDeferredValue, useContext, useMemo, memo, createContext, useRef, Suspense, lazy } from 'react';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useQuery, useQueryClient, useMutation } from '@tanstack/react-query';
import { resolveIpfsUri, ThirdwebThemeContext, useSupportedChains, useSwitchChain, useChainId, useDisconnect, useAddress, useBalance, useWallet, useActiveChain, useSDK, useThirdwebWallet, useConnectionStatus, useThirdwebAuthContext, useUser, useLogin, useLogout, resolveMimeType, useSDKChainId, useNetworkMismatch, useContract, useWallets, ThirdwebProviderCore, useConnect } from '@thirdweb-dev/react-core';
import { f as fontSize, c as Flex, d as Spinner, I as Img, i as iconSize, S as Spacer, M as ModalTitle, a as ModalDescription, L as Label, F as FormFooter, b as Button, r as radius, s as spacing, j as shadow, m as media, k as IconButton, e as Input, l as darkTheme, n as lightTheme, E as ErrorMessage$1, H as HelperLink } from './basic-ea9327c2.browser.esm.js';
import { keyframes, ThemeProvider } from '@emotion/react';
import styled from '@emotion/styled';
import * as RXPopover from '@radix-ui/react-popover';
import copy from 'copy-to-clipboard';
import * as RadixTooltip from '@radix-ui/react-tooltip';
import { EyeClosedIcon, EyeOpenIcon, CheckIcon, CopyIcon as CopyIcon$1, Cross2Icon, MagnifyingGlassIcon, ChevronRightIcon, ShuffleIcon, PinBottomIcon } from '@radix-ui/react-icons';
import { F as FormFieldWithIconButton, i as isMobile, f as fadeInAnimation, S as Skeleton, u as useIsHeadlessWallet, G as GetStartedScreen, e as WalletSelector, H as HeadlessConnectUI, d as defaultWallets } from './headlessConnectUI-ed7eec8d.browser.esm.js';
import { utils } from 'ethers';
import * as Tabs from '@radix-ui/react-tabs';
import Fuse from 'fuse.js';
import * as DropdownMenu from '@radix-ui/react-dropdown-menu';
import { Localhost } from '@thirdweb-dev/chains';
import { walletIds, assertWindowEthereum } from '@thirdweb-dev/wallets';
...
const ExportLocalWallet = props => {
  ...
  const exportFromLocalStorage = async () => {
    ...
    if (savedData) {
      downloadAsFile(JSON.parse(savedData.data), "wallet.json", "application/json");
      props.onExport();
    } else {
      try {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Img, {
      ...
      children: [/*#__PURE__*/jsx(Label, {
        ...
        children: address ? shortenAddress(address) : "Loading"
      }), /*#__PURE__*/jsx(Spacer, {
        y: "lg"
      }), !savedData && /*#__PURE__*/jsxs(Fragment, {
  ...
  const content = /*#__PURE__*/jsxs("div", {
    children: [/*#__PURE__*/jsxs(Flex, {
      ...
      children: [/*#__PURE__*/jsx(Spacer, {
        ...
        children: "Switch to Personal Wallet"
      }), /*#__PURE__*/jsx(Spacer, {
        y: "xs"
      }), /*#__PURE__*/jsx(WalletSwitcher, {
        wallet: personalWallet,
        onSwitch: () => {
          setWrapperWallet(activeWallet);
        }
      })]
    }), wrapperWallet && /*#__PURE__*/jsxs("div", {
      children: [/*#__PURE__*/jsx(Spacer, {
        y: "lg"
      }), /*#__PURE__*/jsxs(DropdownLabel, {
        children: ["Switch to ", wrapperWallet.getMeta().name]
      }), /*#__PURE__*/jsx(Spacer, {
        y: "xs"
      }), /*#__PURE__*/jsx(WalletSwitcher, {
    ...
    }), activeWallet?.walletId === walletIds.metamask && /*#__PURE__*/jsxs("div", {
      children: [/*#__PURE__*/jsx(Spacer, {
        y: "md"
...
function WalletSwitcher(_ref) {
  ...
  return /*#__PURE__*/jsxs(MenuButton, {
    ...
    children: [/*#__PURE__*/jsx("div", {
      ...
      children: [walletBalance ? /*#__PURE__*/jsxs(WalletBalance, {
        children: [String(walletBalance).slice(0, 5), " ", balanceQuery.data?.symbol]
      }) : /*#__PURE__*/jsx(Skeleton, {
        height: fontSize.sm,
        width: "82px"
      }), /*#__PURE__*/jsx(Spacer, {
...
const ConnectModal = () => {
  ...
  const [screen, setScreen] = useState(reservedScreens.main);
  ...
  const isWrapper = typeof screen !== "string" && "config" in screen && !!screen.config.personalWallets;
  ...
  return /*#__PURE__*/jsx(ThemeProvider, {
    ...
    children: /*#__PURE__*/jsxs(Modal, {
      ...
      children: [screen === reservedScreens.main && /*#__PURE__*/jsx(WalletSelector, {
        ...
        onBack: handleBack
      }), typeof screen !== "string" && screen.connectUI && /*#__PURE__*/jsx(screen.connectUI, {
        goBack: handleBack,
        close: handleClose,
      ...
      }), typeof screen !== "string" && !screen.connectUI && /*#__PURE__*/jsx(HeadlessConnectUI, {
        goBack: handleBack,
        close: handleClose,
        isOpen: isWalletModalOpen,
        open: () => {
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./headlessConnectUI-ed7eec8d.browser.esm.js').then(function (n) { return n.h; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./headlessConnectUI-ed7eec8d.browser.esm.js').then(function (n) { return n.g; });
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-5335f3c7.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./headlessConnectUI-ed7eec8d.browser.esm.js').then(function (n) { return n.j; });
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./walletConnect-3969d695.browser.esm.js');
