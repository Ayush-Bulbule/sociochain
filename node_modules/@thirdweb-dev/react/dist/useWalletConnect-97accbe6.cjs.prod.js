...
var coinbaseWallet = require('./headlessConnectUI-942bca52.cjs.prod.js');
...
const ExportLocalWallet = props => {
  ...
  const [savedData, setSavedData] = React.useState("loading");
  React.useEffect(() => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(basic.Img, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(basic.Label, {
        ...
        y: "lg"
      }), !savedData && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
...
const ConnectedWalletDetails = props => {
  ...
  const chain = reactCore.useActiveChain();
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsxs(basic.Flex, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(basic.Spacer, {
        ...
        y: "xs"
      }), /*#__PURE__*/jsxRuntime.jsx(WalletSwitcher, {
        wallet: personalWallet,
        onSwitch: () => {
          setWrapperWallet(activeWallet);
        }
      })]
    }), wrapperWallet && /*#__PURE__*/jsxRuntime.jsxs("div", {
      children: [/*#__PURE__*/jsxRuntime.jsx(basic.Spacer, {
        y: "lg"
      }), /*#__PURE__*/jsxRuntime.jsxs(DropdownLabel, {
    ...
    }), activeWallet?.walletId === wallets.walletIds.metamask && /*#__PURE__*/jsxRuntime.jsxs("div", {
      children: [/*#__PURE__*/jsxRuntime.jsx(basic.Spacer, {
        y: "md"
...
function WalletSwitcher(_ref) {
  ...
  const balanceQuery = reactCore.useBalance();
  const [walletBalance, setWalletBalance] = React.useState(undefined);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx("div", {
      ...
      children: [walletBalance ? /*#__PURE__*/jsxRuntime.jsxs(WalletBalance, {
...
const GetStartedWithWallets = _ref => {
  ...
  const configuredWallets = reactCore.useWallets();
  console.log({
    configuredWallets
  });
  const {
...
const ConnectModal = () => {
  ...
  const [screen, setScreen] = React.useState(reservedScreens.main);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
    theme: typeof modalTheme === "object" ? modalTheme : modalTheme === "light" ? basic.lightTheme : basic.darkTheme,
    children: /*#__PURE__*/jsxRuntime.jsxs(Modal, {
      style: {
        maxWidth: "480px"
      },
      ...
      children: [screen === reservedScreens.main && /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.WalletSelector, {
        ...
        onBack: handleBack
      }), typeof screen !== "string" && screen.connectUI && /*#__PURE__*/jsxRuntime.jsx(screen.connectUI, {
        goBack: handleBack,
        close: handleClose,
      ...
      }), typeof screen !== "string" && !screen.connectUI && /*#__PURE__*/jsxRuntime.jsx(coinbaseWallet.HeadlessConnectUI, {
        goBack: handleBack,
        close: handleClose,
        isOpen: isWalletModalOpen,
        open: () => {
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-942bca52.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-942bca52.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-a06068bd.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-942bca52.cjs.prod.js'); }).then(function (n) { return n.walletConnectV1$1; });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./walletConnect-793ddccc.cjs.prod.js'); });
