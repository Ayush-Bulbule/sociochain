...
import { f as fontSize, c as Flex, d as Spinner, I as Img, i as iconSize, S as Spacer, M as ModalTitle, a as ModalDescription, L as Label, F as FormFooter, b as Button, r as radius, s as spacing, j as shadow, m as media, k as IconButton, e as Input, l as darkTheme, n as lightTheme, E as ErrorMessage$1, H as HelperLink } from './basic-28294d81.esm.js';
...
import { F as FormFieldWithIconButton, i as isMobile, f as fadeInAnimation, S as Skeleton, u as useIsHeadlessWallet, G as GetStartedScreen, e as WalletSelector, H as HeadlessConnectUI, d as defaultWallets } from './headlessConnectUI-d733b1be.esm.js';
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./headlessConnectUI-d733b1be.esm.js').then(function (n) { return n.h; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./headlessConnectUI-d733b1be.esm.js').then(function (n) { return n.g; });
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-ecd686e8.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./headlessConnectUI-d733b1be.esm.js').then(function (n) { return n.j; });
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./walletConnect-6266b8c5.esm.js');
