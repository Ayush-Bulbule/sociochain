...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-b057299e.cjs.dev.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-b057299e.cjs.dev.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-e81953d5.cjs.dev.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./headlessConnectUI-b057299e.cjs.dev.js'); }).then(function (n) { return n.walletConnectV1$1; });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./walletConnect-be8a5d41.cjs.dev.js'); });
